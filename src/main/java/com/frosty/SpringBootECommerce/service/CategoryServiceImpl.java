...
public class CategoryServiceImpl implements CategoryService {
  ...
  public ContentResponse<CategoryDTO> getAllCategories(
    ...
    Page<Category> categoryPage =
        GlobalServiceHelper.getAllItems(
            pageNumber, pageSize, sortBy, sortOrder, categoryRepository);
    List<CategoryDTO> categories =
        GlobalServiceHelper.getDTOContent(
            categoryPage, CategoryDTO.class, modelMapper, "No Categories Found");
  ...
  public CategoryDTO deleteCategory(Long categoryId) {
    ...
    if (productRepository.existsByCategory_Id(categoryId)) {
      throw new APIException(
          "Cannot delete category with id " + categoryId + " because it contains products");
    }
