...
public class WebSecurityConfig {
    ...
    public CommandLineRunner initData(
        ...
        return args -> {
            ...
            Role userRole = roleRepository.findByRole(AppRole.USER).orElseGet(() -> {
                Role newUserRole = new Role(AppRole.USER);
                return roleRepository.save(newUserRole);
            });

            Role sellerRole = roleRepository.findByRole(AppRole.SELLER).orElseGet(() -> {
                Role newSellerRole = new Role(AppRole.SELLER);
                return roleRepository.save(newSellerRole);
            });

            Role adminRole = roleRepository.findByRole(AppRole.ADMIN).orElseGet(() -> {
